...
# Simple documentation strings (replacing documentation_utils)
class SimpleDocumentation:
    help0 = "Help documentation for menu 0"
    help1 = "Help documentation for menu 1" 
    help2 = "Help documentation for menu 2"
    help3 = "Help documentation for menu 3"
    help4 = "Help documentation for menu 4"
    ports = "Common ports: 22(SSH), 80(HTTP), 443(HTTPS), 21(FTP), 25(SMTP)"

doc_utils = SimpleDocumentation()
...
def extract_module_name(module_line):
    """Extract module name from requirements.txt line."""
